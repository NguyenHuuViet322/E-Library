					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Thủ thư có thể bán sách của hội chợ ở phía dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">XÁC NHẬN GIAO DỊCH: </h2>
								<form method="post" action="ban_sach.php" style="border:1px solid darkcyan;padding: 1em;">
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="code" placeholder="Mã giao dịch" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mã giao dịch'" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="name" placeholder="Họ tên người mua" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Họ tên người mua'" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="sdt" placeholder="SĐT người mua" onfocus="this.placeholder = ''" onblur="this.placeholder = 'SĐT người mua'" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="submit" name="submit" value="Bán Sách">
									</div>
								</form>
							</div>
						</div>
