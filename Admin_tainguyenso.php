<?php
    ...
    if(isset($_SESSION['user'])) {
		 if ($_SESSION['user'] == "ADMIN" || substr($_SESSION['user'],0,2) == "GV")
		 {
...
?>
	...
	<head>
        ...
        <?php
         ...
         if(isset($_POST['name']) && isset($_POST['link']) && isset($_POST['gv'])){
             $pdo = new PDO("mysql:host=$host;dbname=$dbname", $username, $password);    //Tạo kết nối
             
             $sql = "SELECT COUNT(*) FROM `tai_nguyen_so`";              //lấy mã sách
             ...
             $sql = "INSERT INTO `tai_nguyen_so`(`STT`, `TENTAILIEU`, `GIAOVIEN`, `NGUON`, `MONHOC`, `THELOAI`, `TMP`) VALUES (".$code.",'".$_POST['name']."','".$_POST['gv']."','".$_POST['nguon']."','".$_POST['subject']."','".$_POST['type']."','".$_POST['link']."')";
             $re = $pdo -> query($sql);
             echo "<script type='text/javascript'>alert('Thêm tài liệu thành công!');</script>";
         } 
         else 
         {
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Thủ thư có thể thêm tài liệu ở phía dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">THÊM TÀI NGUYÊN SỐ: </h2>
								<form method="post" enctype="multipart/form-data" style="border:1px solid darkcyan;padding: 1em;">
									<div class="mt-30" style="border-bottom:1px solid blue;">
										...
										<input type="text" name="name" placeholder="Nhập tên tài liệu" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên tài liệu'" required class="single-input">
									</div>
									<div class="mt-30" style="border-bottom:1px solid blue;">
										<label for"name">Link tài liệu:</label>
										<input type="text" name="link" placeholder="Nhập link tài liệu" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập link tài liệu" required class="single-input">
									</div>
									<div class="mt-30" style="border-bottom:1px solid blue;">
										<label for"name">Tên giáo viên:</label>
										<input type="text" name="gv" placeholder="Nhập tên giáo viên" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên giáo viên" required class="single-input">
									</div>
									<div class="mt-30" style="border-bottom:1px solid blue;">
									...
									<div class="mt-10" style="border-bottom:1px solid blue;">
										...
										<div class="form-select" id="default-select">
											<select name="nguon">
												...
												<option value="Sưu tập">Sưu tầm</option>
											</select>
										</div>
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="submit" name="submit" value="Thêm Tài Liệu">
									</div>
								</form>
							</div>
						</div>
