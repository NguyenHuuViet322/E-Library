	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Đề xuất - Thư viện trường THPT Thái Phiên</title>
		...
		<body>
         ...
         if(isset($_POST['gmail']) && isset($_POST['pass']) && isset($_POST['name']) && isset($_POST['tacgia'])){
             ...
             if ($info['PASS'] == $_POST['pass'])
                 {
                     $de_xuat_sql = "INSERT INTO `de_xuat`(`TENSACH`, `TACGIA`, `TEN`, `SDT`) VALUES ('".$_POST['name']."','".$_POST['tacgia']."','".$info['HOTEN']."','".$info['SDT']."')";
                     $process = $pdo->query($de_xuat_sql);
                 } 
             else 
             {
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Bạn có thể gửi yêu cầu trường mua sách ở dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								...
								<p style= "color: blue; margin-left: 2em;display: list-item;">Đây là nơi đề xuất các cuốn sách mà bạn muốn thư viện trường mua.</p>
								<p style= "color: blue; margin-left: 2em;display: list-item;">Đề xuất sẽ được gửi về cho thủ thư để cân nhắc.</p>
							</div>
						</div>
		        	</div>
		        </div>
            ...
            <div class="whole-wrap" id="work_place">
				<div class="container">
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">ĐƠN ĐỀ XUẤT MUA SÁCH: </h2>
								<form method='post'>
									<div class="mt-10">
									...
									<div class="mt-10">
										<input type="text" name="name" placeholder="Nhập tên sách muốn đề xuất mua:" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên sách muốn đề xuất mua:'" required class="single-input">
									</div>
									<div class="mt-10">
