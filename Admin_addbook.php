...
?>
	...
	<head>
        ...
        <?php
         ...
         if(isset($_POST['name']) && isset($_POST['tacgia']) && isset($_POST['content']) && isset($_POST['nsx']) && isset($_FILES['bia']['tmp_name'])){
             $pdo = new PDO("mysql:host=$host;dbname=$dbname", $username, $password);    //Tạo kết nối
             
             $sql = "SELECT COUNT(*) FROM sach";              //lấy mã sách
             ...
             \Cloudinary\Uploader::upload($file_tmp, array("public_id" => "sach".$code));         //upload
             
             $sql = "INSERT INTO `sach`(`CODE`, `TENSACH`, `TACGIA`, `THELOAI`, `GIOITHIEU`, `STATUS`, `IBSN`) VALUES ('" . $_POST['code'] . "','".$_POST['name']."','".$_POST['tacgia']."','".$_POST['nsx'].$_POST['namsx']."','".$_POST['content']."','','" . $code . "')";
             $re = $pdo -> query($sql);
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Thủ thư có thể thêm sách ở phía dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">THÊM SÁCH: </h2>
								<form method="post" enctype="multipart/form-data" style="border:1px solid darkcyan;padding: 1em;">
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="name" placeholder="Nhập tên sách" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên sách'" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="tacgia" placeholder="Nhập tác giả" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tác giả" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="code" placeholder="Mã sách" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Mã IBSN" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="nsx" placeholder="Nhà xuất bản" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhà xuất bản" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<input type="text" name="namsx" placeholder="Năm xuất bản" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Năm xuất bản" required class="single-input">
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
									...
									<div class="mt-10" style="border-bottom:1px solid blue;">
										<textarea name="content" class="single-textarea" placeholder="Giới thiệu sách: " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Giới thiệu sách: '" required></textarea>
									</div>
									<div class="mt-10" style="border-bottom:1px solid blue;">
