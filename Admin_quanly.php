					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Thủ thư có thể xem các tài khoản ở phía dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">Nhập tên lớp: </h2>
								<form action="#" method="post">
									<div class="mt-10">
										<input type="text" name="lop" placeholder="Nhập tên lớp:" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nhập tên lớp'"  class="single-input" required>
									</div>
									<div class="mt-10">
										<input type="submit" name="submit" id="submit" value="Check danh sách">
									</div>
								</form>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-8 col-md-8">
								...
								<?php
                                    ...
                                    if(isset($_POST['submit']) && $_POST['lop']){
										$pdo->query("SET CHARACTER SET utf8");
                                        $sql = "SELECT * FROM `thanh_vien` WHERE LOP = '".$_POST['lop']."'";
                                        echo $sql;
