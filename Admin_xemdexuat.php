					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Xem các đề xuất mua sách ở dưới.
							</p>
						</div>
                    ...
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">HƯỚNG DÂN: </h2>
							</div>
						</div>
		        	</div>
		        </div>
            ...
            <div class="whole-wrap" id="work_place">
				<div class="container">
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">CÁC SÁCH ĐANG ĐƯỢC ĐỀ XUẤT: </h2>
								...
								<?php
                                    ...
                                    while ($request = $proccess -> fetch()){
                                        echo "<div class='book'>
								              <div class='infor'>
								                  <h3 class='book-container'><span class='book-tieude'>Tên sách: </span>" . $request['TENSACH'] . "</h3>
								                  <h3 class='book-container'><span class='book-tieude'>Tác giả: </span>" . $request['TACGIA'] . "</h3>
								                  <h3 class='book-container' style='border-bottom: 1px solid black;'><span class='book-tieude'>Người đề nghị: </span>" . $request['TEN'] . "</h3>
								                  <h3 class='book-container'><span class='book-tieude'>SĐT: </span>" . $request['SDT'] . "</h3>
								                  <div class='button-group-area mt-10' style='margin: auto;'>
								                     <form action='xoa_de_xuat.php' method='post'>
								                          <input type='hidden' name='name' value='".$request['TENSACH']."'>
								                          <input type='hidden' name='muon' value='".$request['TEN']."'>
