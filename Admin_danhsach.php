					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-7">
							...
							<p class="text-white pt-20 pb-20">
								Thủ thư có thể xác nhận trả sách hoặc xem các sách đang được mượn ở dưới.
							</p>
						</div>
            ...
            <div class="whole-wrap" id="work_place">
				<div class="container">
                    <div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h2 class="mb-30" style="color: blue; border-bottom: 1px solid blue;">CÁC SÁCH ĐANG ĐƯỢC MƯỢN: </h2>
								...
								<?php
                                    ...
                                    $sql = "SELECT * FROM `request` WHERE `CONFIRM` = '1'";
                                    ...
                                    while ($request = $proccess -> fetch()){
                                        ...
                                        echo "<div class='book'>
								              ...
								              <div class='infor'>
								                  ...
								                  <h3 class='book-container'><span class='book-tieude'>Ngày mượn: </span>" . $request['NGAY'] . "</h3>
								                  <div class='button-group-area mt-10' style='margin: auto;'>
								                     <form action='tra_sach.php' method='post'>
								                          <input type='hidden' name='code' value='".$result['IBSN']."'>
								                          <input type='hidden' name='muon' value='".$muon['HOTEN']."'>
								                          <input type='submit' id='submit' class='submit' class='genric-btn info-border' value='Xác nhận đã trả'>
								                     </form>
								                  </div>
								              </div>
								          </div>";
